...
export const register = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
...
export const login = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
...
export const syncUser = async (req: AuthenticatedRequest & { firebaseUser?: any }, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
...
export const getMe = async (req: AuthenticatedRequest & { firebaseUser?: any }, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
    if (!req.user) {
...
export const getUsers = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
