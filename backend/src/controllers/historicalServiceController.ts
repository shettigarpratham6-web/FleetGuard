...
export const createHistoricalService = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
...
export const getHistoricalServicesByVehicle = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
...
export const getAllHistoricalServices = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
    const queryText = `
...
export const deleteHistoricalService = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<Response | void> => {
  try {
    const { id } = req.params;
...
export default {
  ...
  getHistoricalServicesByVehicle,
  getAllHistoricalServices,
  deleteHistoricalService
};
